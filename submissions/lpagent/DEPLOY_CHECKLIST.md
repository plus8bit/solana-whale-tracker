...
It uses LPAgent pool discovery to rank Meteora pools by fee opportunity, volume, TVL, organic score, and risk. For the best pool, it checks top LPers and turns those LP owners into wallet watchlist targets for deeper Solana whale tracking.

The result is a practical agent workflow: discover strong pools, identify skilled LP wallets, and know what to monitor next.
...
It extends my Solana Whale Tracker with LPAgent pool discovery + top LP wallet intelligence:
